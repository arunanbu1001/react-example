...
// // // 2. find 
var array = [15,24,65,86,22,45];
var a  =  array .find(element => element > 22);
console.log("find :" ,a);
...
// 5. reduce
 var a = [15,24,65,86,22,45];
var b = a.reduce(addFunc);
function addFunc(num , add){
    return num + add
 }
 var b = a.reduce( (initial , add) =>{
   return initial * add
 });
 console.log(b);
...
// // string method
//  var stringexMethods = "three string method includes in es6"
